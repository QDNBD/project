...
import service.ReadyBuyService;
...
public class ReadyBuyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ReadyBuyService readyBuyService = new ReadyBuyService();
        ...
        for (String s1 : strings1) {
            ...
            //查找货物是否存在
            Goods goods = readyBuyService.getGoods(Integer.parseInt(strings2[0]));
            if(goods != null) {
        ...
        order.setAccount_id(account.getId());//这出错啦
